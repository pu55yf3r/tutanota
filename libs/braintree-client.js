...
// Use polyfill for setImmediate for performance gains
			...
			}, {"@braintree/browser-detection/is-ie": 7, "@braintree/browser-detection/is-ie9": 8}
		], 17: [
			function (_dereq_, module, exports) {
				'use strict';
...
// Primarily used for testing the client initalization call
				...
				Client.prototype.request = function (options, callback) {
					...
					var requestPromise = new Promise(function (resolve, reject) {
						...
						var shouldCollectData = Boolean(options.endpoint === 'payment_methods/credit_cards'
			...
			}, {"../lib/braintree-error": 42, "../lib/errors": 49, "../lib/promise": 55, "./client": 17, "@braintree/wrap-promise": 14}
		], 22: [
			function (_dereq_, module, exports) {
				'use strict';
			...
			}, {"../../lib/once": 54, "./ajax-driver": 22, "./get-user-agent": 24, "./is-http": 33, "./jsonp-driver": 34}
		], 33: [
			function (_dereq_, module, exports) {
				'use strict';
			...
			}, {"../../lib/querystring": 56, "@braintree/uuid": 10}
		], 35: [
			function (_dereq_, module, exports) {
				'use strict';
			...
			function (_dereq_, module, exports) {
				...
				var isXHRAvailable = typeof window !== 'undefined' && window.XMLHttpRequest && 'withCredentials'
					in new window.XMLHttpRequest();
			...
			}, {"./constants": 43, "./create-authorization-data": 46, "./json-clone": 52}
		], 39: [
			function (_dereq_, module, exports) {
				'use strict';
			...
			}, {"./add-metadata": 38, "./constants": 43, "./promise": 55}
		], 40: [
			function (_dereq_, module, exports) {
				'use strict';
...
// endRemoveIf(production)
			...
			function (_dereq_, module, exports) {
				...
				function createAuthorizationData(authorization) {
					...
					if (_isTokenizationKey(authorization)) {
						...
						data.configUrl = CLIENT_API_URLS[parsedTokenizationKey.environment] + '/merchants/'
							+ parsedTokenizationKey.merchantId + '/client_api/v1/configuration';
					} else {
			...
			}, {"../lib/constants": 43, "../lib/vendor/polyfill": 57}
		], 47: [
			function (_dereq_, module, exports) {
				'use strict';
...
// eslint-disable-next-line no-undef
			...
			}, {"@braintree/extended-promise": 9, "promise-polyfill": 15}
		], 56: [
			function (_dereq_, module, exports) {
				'use strict';
